...
TEST_PARAMS     = {
            ...
            'Cointegration':    {'lookback': 730, 'min': 0.00,          'max': DESIRED_PVALUE, 'pvalue': False},
            'ADFuller':         {'lookback': 63,  'min': 0.00,          'max': DESIRED_PVALUE, 'pvalue': False},
            'Hurst':            {'lookback': 126, 'min': 0.00,          'max': 0.50,           'pvalue': False},
            'Half-life':        {'lookback': 126, 'min': 15,            'max': 35,             'pvalue': False},
